...
int us_rf_trig = 40, us_rf_echo = 41;  // 우측 앞 (평행 확인용 1) — ⚠️ 앞/뒤 가정, 반대면 RR과 맞바꿀 것
...
long readUltrasonicCM(int trigPin, int echoPin) {
  ...
  digitalWrite(trigPin, LOW);
  // 타임아웃 20000us(약 3.4m 상당) — 루프 지연을 과도하게 늘리지 않기 위해 제한
